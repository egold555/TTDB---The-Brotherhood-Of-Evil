...
public abstract class BaseCommand extends Command {
	...
	protected final AbstractTeenTitanBot bot;

	public BaseCommand(@Nonnull AbstractTeenTitanBot bot, @Nonnull String nameIn, @Nullable String argsIn, @Nullable String helpIn, @Nullable String... aliasesIn) {
		this.bot = bot;
		this.name = nameIn;
		if(argsIn != null) {
